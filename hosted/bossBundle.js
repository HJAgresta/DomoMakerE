...
var BattleForm = function BattleForm(props) {
  return React.createElement(
    ...
    React.createElement(
      "label",
      { htmlFor: "name" },
      "Who will fight the Boss: "
    ),
    React.createElement("input", { id: "fighterName", type: "text", name: "name", placeholder: "Fighter Name" }),
    React.createElement("input", { type: "hidden", name: "_csrf", value: props.csrf }),
    React.createElement("input", { className: "fightSubmit", type: "submit", value: "Fight the Boss" })
  );
};
...
var setup = function setup(csrf) {
  ReactDOM.render(React.createElement(BattleForm, { csrf: csrf }), document.querySelector("#bossBattle"));
